% Fig. 3 b) and Fig. 4 b) in the 'Reduced Look Ahead Orthogonal Matching
...
title('ASCE for Rademacher Sparse Signals (SMNR= 15dB)');
grid;
axis tight;
figure;
% Average over all iterations at a particular fraction of measurement value
...
title('SRER for Rademacher Sparse signals (SMNR= 15dB)');
grid;
axis tight;
