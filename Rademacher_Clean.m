% Fig. 1 b) and Fig. 2 b) in the 'Reduced Look Ahead Orthogonal Matching
...
for g=1:length(M)
    for t=1:T
        ...
        [ x, actualsupport] = generateSignal('BernoulliRndSign', N, K  );
        y=A*x;
...
title('ASCE for Rademacher Sparse Signals (Clean Measurements)');
grid;
axis tight;
figure;
% Average over all iterations at a particular fraction of measurement value
...
title('SRER for Rademacher Sparse signals (Clean Measurements)');
grid;
axis tight;
